...
EXTRA_PKGFILES.include( "#{BASEDIR}/lib/rdoc/generator/**/*.{css,rhtml,png,js}" )
...
RDOC_OPTIONS = [
	...
	'-m', 'README',
	'-t', PKG_NAME,
	'-W', 'http://deveiate.org/projects/Darkfish-Rdoc/browser/'
  ]
...
GEMSPEC   = Gem::Specification.new do |gem|
	...
	gem.post_install_message = [
		"To use the Darkfish formatter, just add '-f darkfish' to your rdoc command of choice.",
	  ].join( "\n" )
